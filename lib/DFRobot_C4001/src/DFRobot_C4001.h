...
#define REG_MICRO_MOTION        0x26
  ...
  /**
   * @fn getUart
   * @brief Get the UART baud rate in bps
   * @return uint32_t
   */
  ...
  /**
   * @fn setUart
   * @brief Set the UART baud rate in bps
   * @param baud UART baud rate, unit bps, range 4800~115200, not exceed the maximum baud rate, otherwise you will not be able to reconnect to the module.
   * @return true or false
   */
  bool setUart(uint32_t baud);
